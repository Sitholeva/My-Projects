...
# Have an exit clause if the user wishes o stop adding more things to their cart
...
while True:
    food = input("Enter food or press q to quit: ")
    if food.lower() == 'q':
        break
    else:
...
for food in foods:
    print(food, end=' | ')  # Print horizontally
